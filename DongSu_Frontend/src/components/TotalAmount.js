...
function TotalAmount(props) {
    ...
    useEffect(function () {
        axios.get(`https://dongsu-back.azurewebsites.net/api/Total/` + props.period.year + ('00' + props.period.month).slice(-2)).then(
            function ({ data }) {
    ...
    return (
        <div class="container mx-auto px-4 sm:px-8 max-w-3xl -my-36">
            <div class="bg-white rounded-lg w-72 shadow-2xl border-2 block p-4 m-auto">
                <div class="flex items-center">
                    <span class="rounded-xl relative p-4 bg-pink-200">
